    ...
    <Layout>
      <div className="w-10/12 mx-auto font-semibold">
        <div className="grid md:grid-cols-2 md:m-10 md:ml-0 sm:grid-cols-1 justify-center mb-6">
          ...
          <div className=" md:m-10 md:mr-0 sm:text-center md:text-left hover:animate-none h-full flex ">
            <div className="lg:mt-56 sm:mt-16 md:mt-32 mx-auto animate-bounce">
              <div className="inlne-flex font-semibold">
                Hey There{" "}
                <MdFrontHand className="-rotate-45 text-2xl inline-flex -mt-1 text-yellow-600" />
              </div>
              <h1 className=" font-extrabold text-3xl">Paul Ojo</h1>
              <p className="flex-wrap font-bold ">
                I am a professional Fullstack Software Developer
              </p>
              <div className="space-x-8 inline-flex mt-4 relative">
                {showSocialMediaButton && (
                  ...
                  >
                    ...
                    <Link
                      target="_blank"
                      href="https://www.linkedin.com/in/paul-ojo-86a840227/"
                    >
                ...
                <Link href="#about">
                  <button className="hireme_learnmore bg-gray-700 ease-in-out  active:bg-gray-400 ">
                    Learn More
                  </button>
                </Link>
              </div>
          ...
          <div
            id="about"
            className="flex flex-col scroll-mt-24 md:m-10  md:ml-0 sm:grid-cols-1 sm:mb-6 mt-10 md:mt-20"
          >
            ...
            <div className="flex flex-wrap md:mt-4 sm:mt-2 text-inherit">
              I am a passionate Fullstack Developer with strong background in backend and
              frontend development, skilled at implementing efficient, scalable, and reliable
              software solutions that meet the needs of users. I have a passion for solving
              complex problems and a commitment to staying up-to-date with the latest trends
              and technologies in the field.
              <p className="mt-5">
                My Tools Include: Nextjs | Reactjs | Node.js | Express.js | JavaScript | SQL |
                Postgresql | TailwindCSS | Socket.io | MongoDB | Formik | RTK-Query |
                Redux-Toolkit | Framer-Motion | CSS | APIs | HTML and more....
              </p>
            </div>
          </div>
          <div
            id="services"
            className="flex scroll-mt-24 flex-col mt-0 md:m-10 md:mr-0 sm:mb-6 md:mt-20"
          >
            <h1 className=" font-extrabold text-lg md:text-2xl text-indigo-600 ">
              CONNECT WITH ME
            </h1>
            <div className=" md:mt-4 sm:mt-2">
              ...
              <ul className="list-disc ml-4">
                ...
                <li>
                  Extensive experience working with a variety of technologies and frameworks,
                  and being able to quickly learn and adapt to new ones as needed
                </li>
        ...
        <h1 className="font-extrabold flex justify-center mx-auto text-xl md:text-3xl mb-8 ">
          PROJECTS
        </h1>
        <div id="#projects" className="grid md:grid-cols-2 sm:grid-cols-1 mb-10 -mt-6 gap-6">
          {ProjectsData.map((Projectss) => (
            <div
              key={Projectss.id}
            ...
            >
              <Projects
                ...
                label={Projectss.label}
                github_link={Projectss.github_link}
              />
            </div>
          ))}
        </div>
